...
#   SYSMIRROR25='http://disk.29296819.xyz/92shidai.com/dd/os/laosiji/WinSrv2012r2x64/lite/winsrv2012r2-data-x64-cn-efi.vhd.gz'
  SYSMIRROR1='https://d.02es.com/os/CentOS-7.img.gz'
  SYSMIRROR2='https://d.02es.com/os/CentOS_7.X_NetInstallation_Final.vhd.gz'
  SYSMIRROR3='https://d.02es.com/os/CentOS_8.X_NetInstallation.vhd.gz'
  SYSMIRROR12='https://d.02es.com/os/Disk_Windows_Server_2019_DataCenter_CN_v5.1.vhd.gz'
  SYSMIRROR13='https://d.02es.com/os/Disk_Windows_Server_2016_DataCenter_CN_v4.12.vhd.gz'
  SYSMIRROR14='https://d.02es.com/os/Disk_Windows_Server_2012R2_DataCenter_CN_v4.29.vhd.gz'
  SYSMIRROR15='https://d.02es.com/os/winsrv2012r2-data-x64-cn.vhd.gz'
  SYSMIRROR16='https://d.02es.com/os/Disk_Windows_Server_2008R2_DataCenter_CN_v3.27.vhd.gz'
  SYSMIRROR17='https://d.02es.com/os/winsrv2008r2-data-sp1-x64-cn.vhd.gz'
  ...
  SYSMIRROR25='https://d.02es.com/os/winsrv2012r2-data-x64-cn-efi.vhd.gz'
  ...
  echo -e "\nPlease select an OS:"
  echo "   1) CentOS 7.7 (ext4,已关闭防火墙及SELinux，默认密码Pwd@CentOS)"
  echo "   2) CentOS 7 (cxthhhh,默认密码cxthhhhh.com)"
  echo "   3) CentOS 8 (cxthhhh,默认密码cxthhhhh.com)"
  echo "   4) CentOS 6(默认密码Minijer.com)"
  echo "   5) Debian 11(默认密码Minijer.com)"
  echo "   6) Debian 10(默认密码Minijer.com)"
  echo "   7) Debian 9(默认密码Minijer.com)"
  echo "   8) Debian 8(默认密码Minijer.com)"
  echo "   9) Ubuntu 20.04(默认密码Minijer.com)"
  echo "  10) Ubuntu 18.04(默认密码Minijer.com)"
  echo "  11) Ubuntu 16.04(默认密码Minijer.com)"
  echo "  12) Windows Server 2019(默认密码cxthhhhh.com)"
  echo "  13) Windows Server 2016(默认密码cxthhhhh.com)"
  echo "  14) Windows Server 2012(默认密码cxthhhhh.com)"
  echo "  15) Windows Server 2012 Lite(默认密码nat.ee)"
  echo "  16) Windows Server 2008(默认密码cxthhhhh.com)"
  echo "  17) Windows Server 2008 Lite(默认密码nat.ee)"
  echo "  18) Windows Server 2003(默认密码cxthhhhh.com)"
  echo "  19) Windows Server 2003 Lite(默认密码WinSrv2003x86-Chinese)"
  echo "  20) Windows 10 LTSC Lite(默认密码www.nat.ee)"
  echo "  21) Windows 7 x86 Lite(默认密码Windows7x86-Chinese)"
  echo "  22) Windows 7 Ent Lite(默认密码nat.ee)"
  echo "  23) Windows 7 Ent Lite(UEFI支持甲骨文)(默认密码nat.ee)"
  echo "  24) Windows Server 2008 Lite(UEFI支持甲骨文)(默认密码nat.ee)"
  echo "  25) Windows Server 2012 Lite(UEFI支持甲骨文)(默认密码nat.ee)"
