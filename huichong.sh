...
# Project: jctestrace
# Version: 0.0.2
# Blog:   https://wxf2088.xyz
# Github: https://github.com/wxfyes
#======================================
${Font_suffix}"
...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget -O BestTrace.tar.gz https://github.com/wxfyes/bt/releases/download/v0303/BestTrace.tar.gz && tar -zxf BestTrace.tar.gz && rm BestTrace.tar.gz
